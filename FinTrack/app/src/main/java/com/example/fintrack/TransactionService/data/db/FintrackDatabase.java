...
import com.example.fintrack.AlertService.entity.Reminder;   // 👈 thêm
...
@Database(
        entities = {
                ...
                Reminder.class           // 👈 thêm entity reminders
        },
                    ...
                    INSTANCE = Room.databaseBuilder(
                            ...
                            .addCallback(new Callback() {
                                ...
                                public void onCreate(@NonNull SupportSQLiteDatabase db) {
                                    ...
                                    db.execSQL(
                                            "INSERT INTO accounts (account_id,user_id,name,type_id,balance,status,created_at) " +
                                                    "VALUES ('acc001','u001','Ví chính','WALLET',10000000,'ACTIVE','2026')"
                                    );

                                    db.execSQL(
                                            "INSERT INTO accounts (account_id,user_id,name,type_id,balance,status,created_at) " +
                                                    "VALUES ('acc002','u001','Ngân hàng','WALLET',50000000,'ACTIVE','2026')"
                                    );
                                }
                            })
                            .build();
